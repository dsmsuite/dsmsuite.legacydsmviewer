...
namespace DsmSuite.DsmViewer.Model.Partioning
{
    ...
    class PartitioningAlgorithm
    {
        ...
        public Vector Partition()
        {
            ...
            Debug.WriteLine("Starting Partitioning ");
            ...
            Debug.WriteLine($"Permutations accepted: {_accepted}");
            Debug.WriteLine($"Permutations rejected: {_rejected}");

            TimeSpan t = DateTime.Now - start;
            Debug.WriteLine("Partition completed in : " + t.TotalSeconds);
